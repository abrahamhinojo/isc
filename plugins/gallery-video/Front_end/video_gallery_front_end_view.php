...
$paramssld["thumb_image_width"] = "320";
					...
					?>
						...
						case 'video':
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a target="_blank" class="vyoutube huge_it_videogallery_item"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
							...
							?>
								<a target="_blank" class="vvimeo huge_it_videogallery_item" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
				...
				?>
						<?php
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a target="_blank" class="vyoutube huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $thumb_pic; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>
							<?php
							...
							?>
								<a target="_blank" class="vvimeo huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $imgsrc; ?>" alt="" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>
							<?php
